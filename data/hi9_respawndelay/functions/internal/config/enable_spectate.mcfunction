...
execute if score #Lang Hi9_RDly_Var matches 1 run tellraw @a [{"text":"[Hi9_RespawnDelay] Enabled spectator movement.\n"},{"text":"  While awaiting respawn the player can use all the feature of spectator mode.\n","color":"gray"}]
