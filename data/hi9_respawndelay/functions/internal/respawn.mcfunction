...
# Re-set temporary scoreboard object.
...
execute if score #DisableEff Hi9_RDly_Var matches 0 run execute at @s run playsound entity.arrow.hit_player master @s ~ ~ ~ 1 1
execute if score #DisableEff Hi9_RDly_Var matches 0 run execute at @s run particle poof ~ ~ ~ 0.5 1 0.5 2 50 normal @s
...
# Delete the matching armor stand since it's no longer needed
